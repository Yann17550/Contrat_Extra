  ...
  const handleFinalSubmit = async () => {
    ...
    try {
      ...
      if (emailError) {
        ...
        alert("Contrat enregistré, mais l'envoi de l'email a échoué. Vérifiez la console.");
      } else {
